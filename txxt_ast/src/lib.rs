...
//!
//! This crate provides the core Abstract Syntax Tree (AST) definitions
//! for the txxt format, along with utilities for working with AST nodes,
//! tracking source positions, and performing position-based lookups.
//!
//! ## Modules
//!
