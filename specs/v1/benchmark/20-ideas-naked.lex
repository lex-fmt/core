...
3. Lex: ideas. naked.
    ...
    3.3 The Primitives
        ...
        3.3.5 Annotations
            ...
            :: note:editor :: Maybe this could be better rephrased? Not sure how annotations are linked to the closes element comes in from this phrase. :: note.author :: Done, I'm still keeping it simple, though. They can be attached to any content, and are connected through the annotation position.
