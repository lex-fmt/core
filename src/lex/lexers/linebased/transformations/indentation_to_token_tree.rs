...
) -> Vec<crate::lex::lexers::linebased::tokens::LineTokenTree> {
    use crate::lex::lexers::linebased::tokens::{LineContainerTokenLegacy, LineTokenTree};
...
mod tests {
    use super::*;
    use crate::lex::lexers::linebased::tokens::LineTokenTree;
