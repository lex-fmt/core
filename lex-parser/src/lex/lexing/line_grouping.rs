...
mod tests {
    ...
    fn test_group_with_indent_dedent() {
        ...
        // Should have: SubjectLine, Indent, ParagraphLine, Dedent
    ...
    fn test_group_with_blank_line_token() {
        ...
        // Should have: ParagraphLine (Line1), BlankLine, ParagraphLine (Line2)
    ...
    fn test_dialog_detection() {
        ...
        // Should have: DialogLine, DialogLine
        assert_eq!(line_tokens.len(), 2);
    ...
    fn test_preserves_ranges() {
        ...
        // First token is the actual line
