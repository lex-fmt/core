...
--     theme = "monochrome",   -- "monochrome" (default) or "native"
--   })
--
-- THEMES
-- ------
--   "monochrome": Grayscale highlighting (default). Adapts to dark/light mode.
--                 Keeps focus on document structure, not colorful syntax.
--
--   "native":     Links to standard treesitter groups (@markup.*, @comment, etc.)
--                 Respects user's colorscheme. Use this if you prefer your
--                 theme's colors over Lex's monochrome design.
--
-- KNOWN LIMITATIONS
-- -----------------
...
function M.setup(opts)
  ...
  if ok then
    ...
    -- Theme configuration
    local theme = opts.theme or "monochrome"
    ...
    lsp_config.on_attach = function(client, bufnr)
      ...
      if client.server_capabilities.semanticTokensProvider then
        ...
        if theme == "native" then
          -- NATIVE THEME: Link to standard treesitter/markup groups
          -- ========================================================
          -- Respects user's colorscheme. Maps Lex tokens to standard
          -- Neovim highlight groups that themes typically define.
          ...
          -- ===========================
          -- Intentionally grayscale highlighting to keep focus on document
          -- structure rather than colorful syntax. Adapts to dark/light mode.
