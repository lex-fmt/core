...
1. Structure
    ...
    This section overviews documents, sessions, and nesting rules before diving into each element.
...
3. Syntax
    ...
    The syntax reference below introduces the available markers, line classifications, and nested forms before detailing each rule.
