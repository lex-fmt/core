...
- **Files**: `src/txxt/lexers/linebased/transformations/to_line_tokens.rs`, `pipeline.rs`
...
- **File**: `src/txxt/lexers/linebased/transformations/indentation_to_token_tree.rs`
...
The implementation correctly follows the "Immutable Log" pattern from `docs/dev/guides/on-location.txxt`:
