...
use lex_parser::lex::ast::elements::blank_line_group::BlankLineGroup;
use lex_parser::lex::ast::elements::definition::Definition;
use lex_parser::lex::ast::elements::list::{List, ListItem};
use lex_parser::lex::ast::elements::paragraph::{Paragraph, TextLine};
use lex_parser::lex::ast::elements::session::Session;
use lex_parser::lex::ast::elements::verbatim::{Verbatim, VerbatimGroupItemRef};
use lex_parser::lex::ast::elements::verbatim_line::VerbatimLine;
...
impl<'a> NodeMapVisitor<'a> {
    fn fill_range(&mut self, range: &lex_parser::lex::ast::range::Range) {
