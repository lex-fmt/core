use lex_parser::lex::ast::elements::{
...
use lex_parser::lex::ast::TextContent;
...
mod tests {
    ...
    use lex_parser::lex::ast::{ContentItem, Document as LexDocument, TextContent};
    ...
    fn test_verbatim_language_extraction() {
        ...
        let closing_data = lex_parser::lex::ast::Data::new(
            lex_parser::lex::ast::elements::Label::new("rust".to_string()),
            Vec::new(),
        );
        let verb = LexVerbatim::new(
            ...
            content,
            closing_data,
            lex_parser::lex::ast::elements::verbatim::VerbatimBlockMode::Inflow,
        );
    ...
    fn test_blank_lines_filtered() {
        ...
        let blank = ContentItem::BlankLineGroup(
            lex_parser::lex::ast::elements::BlankLineGroup::new(1, Vec::new()),
        );
